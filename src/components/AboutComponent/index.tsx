    ...
    return (
        <div className={css(style('a').Main)}>
            <div className={css(style('a').Row)}>
                <span style={{fontSize: '1.3rem'}}>Поза при печати текста</span>
                    ...
                    <li>Сиди ровно и держи спину прямой.</li>
                        ...
                        <li>Расслабь мышцы плеч, рук и кистей. Кисти могут немного касаться стола
                            в нижней части клавиатуры, но не переноси вес тела на руки,
                            чтобы не перенапрягать кисти.
                        </li>
                    </ul>
                <img className={css(style('a').Picture)} src={pos} alt='pos'/>
            </div>
            <hr className={css(style('a').Line)}/>
            <div className={css(style('a').Row)}>
                <span style={{fontSize: '1.3rem'}}>Исходная позиция</span>
                <div className={css(style('a').Column)}>
                    <img className={css(style('a').Picture)} src={hand} alt='hands'/>
                    <p>
            ...
            <div className={css(style('a').Row)}>
                ...
                <div className={css(style('a').Column)}>
                    <img className={css(style('a').Picture)} src={keyboard} alt='keyboard'/>
                    <p>
                    ...
                    <ul >
                        ...
                        <li>Установи ритм и соблюдай его, пока печатаешь. Нажимай на клавиши
                            с одинаковым интервалом.</li>
            ...
            <div className={css(style('a').Row)}>
                ...
                <img className={css(style('a').Picture)} src={man} alt='man'/>
            </div>
            <hr className={css(style('a').Line)}/>
            <div className={css(style('a').Row)}>
                <span style={{fontSize: '1.3rem'}}>Скорость печати</span>
                <ul>
                    <li>Не пытайся сразу печатать со скоростью света.
                        Начинай ускоряться, только когда все 10 пальцев
                        привыкнут нажимать правильные клавиши.</li>
